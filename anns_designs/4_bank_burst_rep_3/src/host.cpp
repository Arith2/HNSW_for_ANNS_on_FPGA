...
// read binary file
    ...
    size_t HBM_query_size = 3333 * 128;
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(err, err = krnl_vector_add.setArg(15, buffer_HBM25_data));
    OCL_CHECK(err, err = krnl_vector_add.setArg(16, buffer_HBM26_data));
    OCL_CHECK(err, err = krnl_vector_add.setArg(17, buffer_HBM27_data));
    OCL_CHECK(err, err = krnl_vector_add.setArg(18, buffer_HBM28_data));
    OCL_CHECK(err, err = krnl_vector_add.setArg(19, buffer_HBM29_data));
	...
	OCL_CHECK(err, err = krnl_vector_add.setArg(20, enterpoint_node_));
	OCL_CHECK(err, err = krnl_vector_add.setArg(21, (int)cur_element_count));
	OCL_CHECK(err, err = krnl_vector_add.setArg(22, maxlevel_));
    OCL_CHECK(err, err = krnl_vector_add.setArg(23, ef_));
    OCL_CHECK(err, err = krnl_vector_add.setArg(24, index_link));
    OCL_CHECK(err, err = krnl_vector_add.setArg(25, q_size));
//////////////////////////////   TEMPLATE END  //////////////////////////////
// ------------------------------------------------------
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(
        ...
        buffer_HBM10_data, buffer_HBM11_data, buffer_HBM12_data, buffer_HBM13_data, buffer_HBM14_data, 
        // buffer_HBM15_data, 
        // buffer_HBM16_data, 
