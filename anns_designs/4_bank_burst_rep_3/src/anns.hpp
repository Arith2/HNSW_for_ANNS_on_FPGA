...
void loadLinks(
    ...
    //     ap_uint<512> tmp_data_0 = DDR0_data[total_link_row + 4*j];
    //     ap_uint<512> tmp_data_1 = DDR0_data[total_link_row + 4*j+1];
    //     ap_uint<512> tmp_data_2 = DDR0_data[total_link_row + 4*j+2];
    //     ap_uint<512> tmp_data_3 = DDR0_data[total_link_row + 4*j+3];
...
void readHighLinks(
    ...
    readHighLinks:
    do {
        if (!high_link_id_stream_array[0].empty() | !high_link_id_stream_array[1].empty() | !high_link_id_stream_array[2].empty()) {
...
void adderTree(
    hls::stream<ap_uint<512> > sub_stream_array[4], 
            ...
            if (!sub_stream_array[0].empty() & !sub_stream_array[1].empty() & !sub_stream_array[2].empty() & !sub_stream_array[3].empty()) {
                ...
                if (stop_flag==1) {
                    ...
                    for (int j = 0; j < size; j++) {
                        ...
                        sub_dist_list[2] = sub_stream_array[1].read();
                        sub_dist_list[3] = sub_stream_array[1].read();
                        sub_dist_list[4] = sub_stream_array[2].read();
                        sub_dist_list[5] = sub_stream_array[2].read();
                        sub_dist_list[6] = sub_stream_array[3].read();
                        sub_dist_list[7] = sub_stream_array[3].read();
                        stream_count += 2;
...
void writeMem(
    ...
    do {
        if (!list_stream_array[0].empty() | !list_stream_array[1].empty() | !list_stream_array[2].empty()) {
            if (!list_stream_array[0].empty()) {
                ap_uint<32> q_count = list_stream_array[0].read();
                
                DDR_pos = 3 * q_count * 512;
