...
#pragma HLS stream variable=index_link_stream depth=8
    ...
    hls::stream<ap_uint<512> > query_stream_array[1][4];
...
#pragma HLS stream variable=gnd_layer_links_stream depth=8
    ...
    hls::stream<ap_uint<32> > node_id_stream_array[1][5];
#pragma HLS stream variable=node_id_stream_array depth=8

    hls::stream<ap_uint<512> > data_stream_array[1][4];
...
#pragma HLS stream variable=gnd_link_stream depth=8
    ...
    hls::stream<ap_uint<512> > sub_stream_array[1][4];
...
#pragma HLS dataflow
    ...
    readHBM_link(HBM16_data, node_id_stream_array[0][4], gnd_link_stream, cur_element_count, q_size);
