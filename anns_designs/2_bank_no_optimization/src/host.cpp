...
//////////////////////////////   TEMPLATE START  //////////////////////////////
    ...
    OCL_CHECK(err, err = krnl_vector_add.setArg(2, buffer_HBM16_data));
    ...
    OCL_CHECK(err, err = krnl_vector_add.setArg(3, buffer_DDR0_data));
    OCL_CHECK(err, err = krnl_vector_add.setArg(4, buffer_DDR1_data));

	OCL_CHECK(err, err = krnl_vector_add.setArg(5, enterpoint_node_));
	OCL_CHECK(err, err = krnl_vector_add.setArg(6, (int)cur_element_count));
	OCL_CHECK(err, err = krnl_vector_add.setArg(7, maxlevel_));
    OCL_CHECK(err, err = krnl_vector_add.setArg(8, ef_));
    OCL_CHECK(err, err = krnl_vector_add.setArg(9, index_link));
    OCL_CHECK(err, err = krnl_vector_add.setArg(10, q_size));
//////////////////////////////   TEMPLATE END  //////////////////////////////
// ------------------------------------------------------
