...
#pragma HLS stream variable=query_stream_array depth=64
    hls::stream<ap_uint<512> > dist_query_stream_array[4][4];
#pragma HLS stream variable=dist_query_stream_array depth=64
...
#pragma HLS stream variable=gnd_link_stream_array depth=64
    ...
    hls::stream<ap_uint<512> > sub_stream_array[4][4];
...
#pragma HLS dataflow
    ...
    loadLinks(HBM25_data, index_link_stream, query_stream_array, cur_element_count, index_link, q_size);

    // loadQuery(HBM27_data, query_stream_array[0], batch_q_size);
    // loadQuery(HBM28_data, query_stream_array[1], batch_q_size);
    // loadQuery(HBM29_data, query_stream_array[2], batch_q_size);
    // loadQuery(HBM30_data, query_stream_array[3], batch_q_size);
    distributeQuery(query_stream_array[0], dist_query_stream_array[0], batch_q_size);
    distributeQuery(query_stream_array[1], dist_query_stream_array[1], batch_q_size);
    distributeQuery(query_stream_array[2], dist_query_stream_array[2], batch_q_size);
    distributeQuery(query_stream_array[3], dist_query_stream_array[3], batch_q_size);
    ...
    epNode_high(ep_node_stream_array[2], high_link_id_stream_array[2], enterpoint_node_, maxlevel_, batch_q_size);
    epNode_high(ep_node_stream_array[3], high_link_id_stream_array[3], enterpoint_node_, maxlevel_, batch_q_size);
    ...
    mergeLink(high_layer_links_stream_array[2], gnd_layer_links_stream_array[2], node_id_stream_array[2], batch_q_size);
    mergeLink(high_layer_links_stream_array[3], gnd_layer_links_stream_array[3], node_id_stream_array[3], batch_q_size);
    // mergeLink(high_layer_links_stream_array[4], gnd_layer_links_stream_array[4], node_id_stream_array[4], batch_q_size);
    ...
    readHBM_data(HBM10_data, node_id_stream_array[2][0], data_stream_array[2][0], cur_element_count, batch_q_size);
    readHBM_data(HBM11_data, node_id_stream_array[2][1], data_stream_array[2][1], cur_element_count, batch_q_size);
    readHBM_data(HBM12_data, node_id_stream_array[2][2], data_stream_array[2][2], cur_element_count, batch_q_size);
    readHBM_data(HBM13_data, node_id_stream_array[2][3], data_stream_array[2][3], cur_element_count, batch_q_size);

    readHBM_data(HBM15_data, node_id_stream_array[3][0], data_stream_array[3][0], cur_element_count, batch_q_size);
    readHBM_data(HBM16_data, node_id_stream_array[3][1], data_stream_array[3][1], cur_element_count, batch_q_size);
    readHBM_data(HBM17_data, node_id_stream_array[3][2], data_stream_array[3][2], cur_element_count, batch_q_size);
    readHBM_data(HBM18_data, node_id_stream_array[3][3], data_stream_array[3][3], cur_element_count, batch_q_size);

    // readHBM_data(HBM20_data, node_id_stream_array[4][0], data_stream_array[4][0], cur_element_count, batch_q_size);
    // readHBM_data(HBM21_data, node_id_stream_array[4][1], data_stream_array[4][1], cur_element_count, batch_q_size);
    // readHBM_data(HBM22_data, node_id_stream_array[4][2], data_stream_array[4][2], cur_element_count, batch_q_size);
    // readHBM_data(HBM23_data, node_id_stream_array[4][3], data_stream_array[4][3], cur_element_count, batch_q_size);
    ...
    readHBM_link(HBM14_data, node_id_stream_array[2][4], gnd_link_stream_array[2], cur_element_count, batch_q_size);
    readHBM_link(HBM19_data, node_id_stream_array[3][4], gnd_link_stream_array[3], cur_element_count, batch_q_size);
    // readHBM_link(HBM24_data, node_id_stream_array[4][4], gnd_link_stream_array[4], cur_element_count, batch_q_size);

    subtractQuery(dist_query_stream_array[0][0], data_stream_array[0][0], sub_stream_array[0][0], batch_q_size);
    subtractQuery(dist_query_stream_array[0][1], data_stream_array[0][1], sub_stream_array[0][1], batch_q_size);
    subtractQuery(dist_query_stream_array[0][2], data_stream_array[0][2], sub_stream_array[0][2], batch_q_size);
    subtractQuery(dist_query_stream_array[0][3], data_stream_array[0][3], sub_stream_array[0][3], batch_q_size);

    subtractQuery(dist_query_stream_array[1][0], data_stream_array[1][0], sub_stream_array[1][0], batch_q_size);
    subtractQuery(dist_query_stream_array[1][1], data_stream_array[1][1], sub_stream_array[1][1], batch_q_size);
    subtractQuery(dist_query_stream_array[1][2], data_stream_array[1][2], sub_stream_array[1][2], batch_q_size);
    subtractQuery(dist_query_stream_array[1][3], data_stream_array[1][3], sub_stream_array[1][3], batch_q_size);

    subtractQuery(dist_query_stream_array[2][0], data_stream_array[2][0], sub_stream_array[2][0], batch_q_size);
    subtractQuery(dist_query_stream_array[2][1], data_stream_array[2][1], sub_stream_array[2][1], batch_q_size);
    subtractQuery(dist_query_stream_array[2][2], data_stream_array[2][2], sub_stream_array[2][2], batch_q_size);
    subtractQuery(dist_query_stream_array[2][3], data_stream_array[2][3], sub_stream_array[2][3], batch_q_size);

    subtractQuery(dist_query_stream_array[3][0], data_stream_array[3][0], sub_stream_array[3][0], batch_q_size);
    subtractQuery(dist_query_stream_array[3][1], data_stream_array[3][1], sub_stream_array[3][1], batch_q_size);
    subtractQuery(dist_query_stream_array[3][2], data_stream_array[3][2], sub_stream_array[3][2], batch_q_size);
    subtractQuery(dist_query_stream_array[3][3], data_stream_array[3][3], sub_stream_array[3][3], batch_q_size);

    // subtractQuery(query_stream_array[4][0], data_stream_array[4][0], sub_stream_array[4][0], batch_q_size);
    // subtractQuery(query_stream_array[4][1], data_stream_array[4][1], sub_stream_array[4][1], batch_q_size);
    // subtractQuery(query_stream_array[4][2], data_stream_array[4][2], sub_stream_array[4][2], batch_q_size);
    // subtractQuery(query_stream_array[4][3], data_stream_array[4][3], sub_stream_array[4][3], batch_q_size);
    ...
    adderTree(sub_stream_array[2], l2dist_stream_array[2], batch_q_size);
    adderTree(sub_stream_array[3], l2dist_stream_array[3], batch_q_size);
    // adderTree(sub_stream_array[4], l2dist_stream_array[4], batch_q_size);
    ...
    // priorityQueue(l2dist_stream_array[4], ep_node_stream_array[4], cache_index_stream_array[4], list_stream_array[4], maxlevel_, enterpoint_node_, batch_q_size);
    ...
    // cacheGndLinks(gnd_link_stream_array[4], cache_index_stream_array[4], gnd_layer_links_stream_array[4], batch_q_size);
