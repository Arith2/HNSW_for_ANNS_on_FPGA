...
void loadDDR(
    ...
    hls::stream<ap_uint<512> > query_stream_array[8], 
    int cur_element_count, 
    int index_link,
    int q_size) {
    ...
    for (int j = 0; j < q_size; j++) {
        ...
        ap_uint<512> tmp_data_0 = DDR0_data[total_link_row + 8*j];
        ap_uint<512> tmp_data_1 = DDR0_data[total_link_row + 8*j+1];
        ap_uint<512> tmp_data_2 = DDR0_data[total_link_row + 8*j+2];
        ap_uint<512> tmp_data_3 = DDR0_data[total_link_row + 8*j+3];
        ap_uint<512> tmp_data_4 = DDR0_data[total_link_row + 8*j+4];
        ap_uint<512> tmp_data_5 = DDR0_data[total_link_row + 8*j+5];
        ap_uint<512> tmp_data_6 = DDR0_data[total_link_row + 8*j+6];
        ap_uint<512> tmp_data_7 = DDR0_data[total_link_row + 8*j+7];
        query_stream_array[0].write(tmp_data_0);
        query_stream_array[1].write(tmp_data_1);
        query_stream_array[2].write(tmp_data_2);
        query_stream_array[3].write(tmp_data_3);
        query_stream_array[4].write(tmp_data_4);
        query_stream_array[5].write(tmp_data_5);
        query_stream_array[6].write(tmp_data_6);
        query_stream_array[7].write(tmp_data_7);
    }
...
void mergeLink(
    ...
    hls::stream<ap_uint<32> > node_id_stream_array[10],
    int q_size 
) {
    #pragma HLS inline off
        ...
        do {
            if (!high_layer_links_stream.empty()) {
                ...
                if (stop_flag==1) {
                    ...
                    // node_id_stream_array[3].write(meta_info_32);
                    // node_id_stream_array[4].write(meta_info_32);
                }
                else {
                    ...
                    for (int j = 0; j < size; j++) {
                        ...
                        // node_id_stream_array[3].write(node_id);
                        // node_id_stream_array[4].write(node_id);
                        for (int m = 0; m < 10; m++) {
                            #pragma HLS unroll
        ...
        do {
            if (!node_id_stream.empty()) {
                ...
                if (stop_flag==1) {
                    ...
                    for (int j = 0; j < size; j++) {
                        for (int k = 0; k < 2; k++) {
                            ...
                            if (k==0) {
                                ...
                                ap_uint<512> hbm_tmp = (node_id==0x00ffffff) ? no_hbm_request : HBM_data[1 * node_id + k - 1]; 
                    ...
                    //     }
                    //     else {
                    //         HBM_data.read_request(node_id, 1);
                    //         for (int k = 0; k < 1; k++) {
                    //             #pragma HLS unroll
        ...
        do {
            if (!data_stream.empty()) {
                ...
                if (stop_flag==1) {
                    ...
                    int node_id_list[32];
                    ap_uint<512> node_data[1];
                    ap_uint<512> sub_dist_list[1];
...
void adderTree(
    hls::stream<ap_uint<512> > sub_stream_array[8], 
    ...
    for (int j = 0; j < q_size; j++) {
        ...
        adderTreeLoop:
        do {
            if (!sub_stream_array[0].empty() & !sub_stream_array[3].empty() & !sub_stream_array[5].empty() & !sub_stream_array[7].empty()) {
                ap_uint<512> meta_info_512_0 = sub_stream_array[0].read();
                ap_uint<512> meta_info_512_1 = sub_stream_array[1].read();
                ap_uint<512> meta_info_512_2 = sub_stream_array[2].read();
                ap_uint<512> meta_info_512_3 = sub_stream_array[3].read();
                ap_uint<512> meta_info_512_4 = sub_stream_array[4].read();
                ap_uint<512> meta_info_512_5 = sub_stream_array[5].read();
                ap_uint<512> meta_info_512_6 = sub_stream_array[6].read();
                ap_uint<512> meta_info_512_7 = sub_stream_array[7].read();
                stream_count++;
                ...
                if (stop_flag==1) {
                    ...
                    for (int j = 0; j < size; j++) {
                        ...
                        ap_uint<512> node_tmp_2 = sub_stream_array[2].read();
                        ap_uint<512> node_tmp_3 = sub_stream_array[3].read();
                        ap_uint<512> node_tmp_4 = sub_stream_array[4].read();
                        ap_uint<512> node_tmp_5 = sub_stream_array[5].read();
                        ap_uint<512> node_tmp_6 = sub_stream_array[6].read();
                        ap_uint<512> node_tmp_7 = sub_stream_array[7].read();
                        stream_count++;

                        // node_id_list[j] = node_tmp_0(23, 0);

                        sub_dist_list[0] = sub_stream_array[0].read();
                        sub_dist_list[1] = sub_stream_array[1].read();
                        sub_dist_list[2] = sub_stream_array[2].read();
                        sub_dist_list[3] = sub_stream_array[3].read();
                        sub_dist_list[4] = sub_stream_array[4].read();
                        sub_dist_list[5] = sub_stream_array[5].read();
                        sub_dist_list[6] = sub_stream_array[6].read();
                        sub_dist_list[7] = sub_stream_array[7].read();
                        stream_count += 2;
...
void cacheGndLinks(
    ...
    for (int j = 0; j < q_size; j++) {
        ...
        cacheGndLinksLoop:
        do {
            if (!gnd_link_stream_array[0].empty() & !gnd_link_stream_array[1].empty()) {
                ap_uint<512> meta_info_512_0 = gnd_link_stream_array[0].read();
                ap_uint<512> meta_info_512_1 = gnd_link_stream_array[1].read();
                ...
                for (int j = 0; j < size; j++) {
                    #pragma HLS pipeline II=1
                    ap_uint<512> gnd_link_0 = gnd_link_stream_array[0].read();
                    ap_uint<512> gnd_link_1 = gnd_link_stream_array[1].read();
